...
import type { CopyBuildEntry, CopyHooks } from "./builders/copy/types.js";
import type { MkdistBuildEntry, MkdistHooks } from "./builders/mkdist/types.js";
import type {
  RollupBuildEntry,
  RollupBuildOptions,
  RollupHooks,
} from "./builders/rollup/types.js";
import type {
  UntypedBuildEntry,
  UntypedHooks,
} from "./builders/untyped/types.js";
...
export type { MkdistBuildEntry } from "./builders/mkdist/types.js";
export type { CopyBuildEntry } from "./builders/copy/types.js";
export type {
  UntypedBuildEntry,
  UntypedOutput,
  UntypedOutputs,
 ...
 */
export type UnifiedBuildConfig = {
  /**
...
} & DeepPartial<Omit<BuildOptions, "entries">>;
