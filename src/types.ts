 ...
 * - jsr: JSR's built-in bundler for the JSR registry
 ...
 * - untyped: A bundler that strips type information
 */
...
export type BuildPublishConfig = {
  ...
  /**
   * When `true`, enables JSR to process complex types, which may affect performance.
   * Enable this only if your package requires complex type definitions.
   * @default false
   */
