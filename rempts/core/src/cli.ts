import type { CLI, Command, RemptsConfig, CommandManifest, CommandLoader, ResolvedConfig, CLIOption, TerminalInfo, RuntimeInfo } from './types'
...
export async function createCLI<
  TPlugins extends readonly RemptsPlugin[] = []
>(
  ...
  const loadedConfig: RemptsConfig = loadedConfigData || (remptsConfigSchema.parse(configOverride || {}) as LoadedConfig)
