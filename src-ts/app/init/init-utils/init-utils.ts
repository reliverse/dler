...
import { checkMissingDependencies } from "~/app/add/add-local/core/deps";
import { getPromptContent } from "~/app/add/add-local/core/prompts";
import {
...
import { initializeGitRepo } from "~/app/init/use-template/cp-modules/git-deploy-prompts/git";
import { createPackageJSON } from "~/app/utils/createPackageJSON";
import { askAppOrLib } from "~/app/utils/prompts/askAppOrLib";
import { askInstallDeps } from "~/app/utils/prompts/askInstallDeps";
import { askOpenInIDE } from "~/app/utils/prompts/askOpenInIDE";
import { askProjectName } from "~/app/utils/prompts/askProjectName";
import { shouldInitGit } from "~/app/utils/prompts/shouldInitGit";
