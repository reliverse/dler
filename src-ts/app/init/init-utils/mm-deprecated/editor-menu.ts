...
import { handleIntegrations } from "~/app/init/mm-deprecated/editor-impl";
import { manageShadcn } from "~/app/init/mm-deprecated/shadcn/shadcn-mod";
import { deployProject } from "~/app/init/use-template/cp-modules/git-deploy-prompts/deploy";
import {
  createCommit,
  handleGithubRepo,
  initGitDir,
...
import { handleCleanup } from "~/app/utils/handlers/handleCleanup";
import { handleCodemods } from "~/app/utils/handlers/handleCodemods";
import { initGithubSDK } from "~/app/utils/instanceGithub";
import { initVercelSDK } from "~/app/utils/instanceVercel";
import { checkScriptExists } from "~/app/utils/pkgJsonHelpers";
