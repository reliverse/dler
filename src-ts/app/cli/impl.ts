...
import { cliJsrPath, UNKNOWN_VALUE } from "~/app/config/constants";
import { detectProject } from "~/app/config/detect";
import { ad, getRandomMessage, getWelcomeTitle, premium } from "~/app/db/messages";
import { showManualBuilderMenu } from "~/app/init/init-utils/init-impl";
import { getMainMenuOptions } from "~/app/init/use-template/cp-modules/cli-main-modules/cli-menu-items/getMainMenuOptions";
import { showCloneProjectMenu } from "~/app/init/use-template/cp-modules/cli-main-modules/cli-menu-items/showCloneProjectMenu";
import { showEndPrompt } from "~/app/init/use-template/cp-modules/cli-main-modules/modules/showStartEndPrompt";
import {
  showNewProjectMenu,
  showOpenProjectMenu,
} from "~/app/providers/reliverse-stack/reliverse-stack-mod";
import { showDevToolsMenu } from "~/app/toolbox/toolbox-impl";
import type { ParamsOmitSkipPN } from "~/app/types/mod";
import { showNativeCliMenu } from "~/app/utils/native-cli/nc-mod";
import { default as webCmd } from "~/app/web/cmd";
...
export async function showWebUiMenu() {
  await callCmd(webCmd, {}); // src-ts/app/web/cmd.ts
}
