...
import type { BuildContext, UntypedBuildEntry, UntypedOutputs } from "~/app/types/mod";
        ...
        declaration: entry.declaration
          ? {
              contents: generateTypes(schema, {
                ...
                // addDefaults: true, // TODO: Add JSDoc default values (allow to configure via reliverse.ts)
                // addDescription: true, // TODO: Add JSDoc descriptions (allow to configure via reliverse.ts)
              }),
