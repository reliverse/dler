// usage example: bun <src-ts/dler.ts | dler> update migrate --to-catalog --dry-run
// usage example: bun <src-ts/dler.ts | dler> update migrate --from-catalog --remove-catalog
