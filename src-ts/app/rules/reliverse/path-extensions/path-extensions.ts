...
import { ALLOWED_IMPORT_EXTENSIONS, STRICT_IMPORT_EXTENSIONS } from "~/app/rules/rules-consts";
import { getAllFiles, getLineNumber } from "~/app/rules/rules-utils";
import type { CheckIssue, CheckResult, RulesCheckOptions } from "~/app/types/mod";
