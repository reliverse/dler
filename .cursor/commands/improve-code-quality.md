...
| 1 | `@reliverse/build` | 2025-12-06 18:52:42 | completed | Extracted shared utilities (rebuild queue, log extraction, Go build handler, package filtering), replaced magic values with constants, improved type safety by replacing `any` types, reduced code duplication significantly |
| 2 | `@reliverse/bump` | - | - | - |
| 3 | `@reliverse/config` | - | - | - |
