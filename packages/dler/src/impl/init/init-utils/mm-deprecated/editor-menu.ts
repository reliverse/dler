...
import { useLanguine } from "~/impl/add/add-local/i18n/languine";
import { getProjectContent } from "~/impl/config/content";
import { envArgImpl } from "~/impl/env/env-impl";
import { manageDrizzleSchema } from "~/impl/init/mm-deprecated/drizzle/manageDrizzleSchema";
import { handleIntegrations } from "~/impl/init/mm-deprecated/editor-impl";
import { manageShadcn } from "~/impl/init/mm-deprecated/shadcn/shadcn-mod";
import { deployProject } from "~/impl/init/use-template/cp-modules/git-deploy-prompts/deploy";
import {
	createCommit,
	handleGithubRepo,
	initGitDir,
...
import { checkGithubRepoOwnership } from "~/impl/init/use-template/cp-modules/git-deploy-prompts/github";
import { ensureDbInitialized } from "~/impl/init/use-template/cp-modules/git-deploy-prompts/helpers/handlePkgJsonScripts";
import { checkVercelDeployment } from "~/impl/init/use-template/cp-modules/git-deploy-prompts/vercel/vercel-check";
import type { ReliverseConfig } from "~/impl/schema/mod";
import type { DetectedProject } from "~/impl/types/mod";
...
import { handleCleanup } from "~/impl/utils/handlers/handleCleanup";
import { handleCodemods } from "~/impl/utils/handlers/handleCodemods";
import { initGithubSDK } from "~/impl/utils/instanceGithub";
import { initVercelSDK } from "~/impl/utils/instanceVercel";
import { checkScriptExists } from "~/impl/utils/pkgJsonHelpers";
