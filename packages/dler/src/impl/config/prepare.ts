...
function getcommonEntrySrcDir(isDev: boolean): string {
...
// Schema: ${schemaUrl}
{
  ...
  "projectDescription": ${JSON.stringify(commonDescriptionValue)},
  ...
  "commonEntrySrcDir": "${getcommonEntrySrcDir(isDev)}",
  "commonIsCLI": {
    ".": {
      "enabled": false,
      "scripts": {}
...
function getcommonIsCLI(isDev: boolean): string {
  return isDev
    ? `commonIsCLI: {
  ".": { enabled: true, scripts: { rse: "rse.ts" } },
},`
    : `commonIsCLI: {
