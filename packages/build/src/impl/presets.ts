// packages/build/src/impl/presets.ts
...
export function applyFrontendPreset(options: BuildOptions): BuildOptions {
  return {
    ...
    sourcemap: options.production ? ("linked" as const) : ("inline" as const),
...
export function applyNodePreset(options: BuildOptions): BuildOptions {
  return {
    ...
    splitting: false,
    minify: options.production ?? false,
    sourcemap: options.production ? ("none" as const) : ("inline" as const),
