// packages/build/src/impl/package-json-transformer.ts

import { resolve } from "node:path";
import { readPackageJSON, writePackageJSON } from "@reliverse/dler-pkg-tsc";
import type { PackageKind } from "@reliverse/dler-config/impl/publish";
...
export async function preparePackageJsonForPublishing(
  ...
  try {
    ...
    // Transform exports field to point to built files
    if (pkg.exports) {
