...
1. **Configure**: Set up `dler.config.ts`
...
- [Type Inference](/libraries/rempts/core-concepts/type-inference) - Runtime type inference
- [Configuration](/libraries/rempts/core-concepts/configuration) - CLI configuration options
