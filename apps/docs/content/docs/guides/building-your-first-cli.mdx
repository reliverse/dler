...
Customize your CLI behavior with `dler.config.ts`:
...
- [Schema Validation](/libraries/rempts/guides/schema-validation) - Advanced validation
- [Interactive Prompts](/libraries/rempts/guides/interactive-prompts) - Rich user interactions
- [Testing](/libraries/rempts/guides/testing) - Comprehensive testing strategies
- [Distribution](/libraries/rempts/guides/distribution) - Publishing and deployment

## Complete Example

Find the complete todo CLI example in the [Rempts repository](https://github.com/reliverse/rempts/tree/main/examples/todo-cli).