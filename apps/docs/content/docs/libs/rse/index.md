...
- 😋 **better better-auth cli**: use `rse better auth` to use improved version of [better-auth cli](https://better-auth.com/docs/concepts/cli), which is more stable and natively works with bun, thanks to [@reliverse/rempts](https://github.com/reliverse/dler).
...
I love community input! Check out my [Contributing Guide](https://docs.reliverse.org/docs/intro/contributing/) for how to get involved or propose new features.
