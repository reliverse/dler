...
```typescript
import { shell } from '@reliverse/rempts-core'
...
```typescript
import { colors } from '@reliverse/rempts-core'
...
- **[Command Organization Guide](/docs/libs/rempts/guides/command-organization)** - Advanced patterns
- **[External Tool Integration](/docs/libs/rempts/guides/external-tools)** - Working with other tools
- **[Shell Integration Guide](/docs/libs/rempts/guides/shell-integration)** - Command execution patterns
