...
- **[Plugin System Guide](/docs/libs/rempts/guides/plugin-system)** - Deep dive into plugins
- **[Configuration Management](/docs/libs/rempts/guides/configuration)** - Advanced config patterns
- **[Long-running Processes](/docs/libs/rempts/guides/long-running)** - Server and daemon patterns
- **[Real-time CLI](/docs/libs/rempts/guides/real-time)** - Live updates and streaming
