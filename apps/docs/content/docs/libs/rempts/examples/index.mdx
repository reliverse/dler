...
1. **[Hello World](/docs/libs/rempts/examples/hello-world)** - Absolute basics (5 min)
2. **[Task Runner](/docs/libs/rempts/examples/task-runner)** - Validation and interactivity (15 min)
3. **[Git Tool](/docs/libs/rempts/examples/git-tool)** - Command structure and organization (15 min)

## Example Projects

Check out these complete example projects in the [Rempts repository](https://github.com/reliverse/dler/tree/main/examples):
