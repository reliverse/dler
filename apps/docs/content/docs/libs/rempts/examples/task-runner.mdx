...
```typescript
import { prompt } from '@reliverse/rempts-core'
...
```typescript
import { spinner } from '@reliverse/rempts-core'
...
- **[Git Tool Example](/docs/libs/rempts/examples/git-tool)** - Learn command organization
- **[Schema Validation Guide](/docs/libs/rempts/guides/schema-validation)** - Deep dive into validation
- **[Interactive Prompts Guide](/docs/libs/rempts/guides/interactive-prompts)** - Advanced prompt patterns
