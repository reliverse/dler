...
| **Commands Directory** | `./cmds` | Where to find command files (REQUIRED) |
...
- [defineConfig API](/docs/libs/rempts/api/define-config) - Configuration helper
- [rempts CLI](/docs/rempts-cli) - CLI commands
- [Building & Distribution](/docs/libs/rempts/guides/distribution) - Build and release process