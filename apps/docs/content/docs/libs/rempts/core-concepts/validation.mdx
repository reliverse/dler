...
<Tabs groupId="validation-basic" defaultValue="zod">
  ...
  <Tab value="valibot" label="Valibot">
    ```typescript
    import { defineCommand, option } from '@reliverse/rempts'
...
<Tabs groupId="coercion-examples" defaultValue="zod">
  <Tab value="zod" label="Zod">
    ```typescript
    import { z } from 'zod'
...
- [Type Inference](/docs/libs/rempts/core-concepts/type-inference) - Automatic type inference
