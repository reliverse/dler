...
### @reliverse/dler rempts generate
...
cd packages/my-package && @reliverse/dler rempts dev
```
...
- `REMPTS_VERSION` - The version of the @reliverse/dler rempts CLI
...
jobs:
  test:
    ...
    steps:
      ...
      - name: Run tests
        run: @reliverse/dler rempts test --coverage
        
      - name: Build for all platforms
        run: @reliverse/dler rempts build --targets all
