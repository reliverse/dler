...
- [defineCommand](/docs/libs/rempts/api/define-command) - Use options in commands
- [Validation](/docs/libs/rempts/core-concepts/validation) - Learn about validation
- [Type Inference](/docs/libs/rempts/core-concepts/type-inference) - How types are inferred