...
export default defineCommand({
  ...
  handler: async ({ prompt, colors, spinner }) => {
    ...
    console.log(colors.green('\n✓'), `cd ${projectName} && @reliverse/dler rempts dev`)
  }
})
```
...
- [Testing](/docs/libs/rempts/guides/testing) - Test interactive commands
- [Building Your First CLI](/docs/libs/rempts/guides/building-your-first-cli) - Complete example
- [@reliverse/rempts-utils](/docs/libs/rempts/packages/utils) - Utility functions reference