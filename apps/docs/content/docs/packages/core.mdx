...
<Callout type="info">
  @reliverse/rempts-core integrates with Standard Schema v1 for validation and uses Zustand for plugin state management. It supports Zod, Valibot, ArkType, and other schema libraries.
</Callout>
...
<Tabs groupId="package-manager" defaultValue="bun">
  ...
  <Tab value="npm" label="npm">
    ```bash
    npm install @reliverse/rempts-core
    ```
  </Tab>
  <Tab value="pnpm" label="pnpm">
    ```bash
    pnpm add @reliverse/rempts-core
    ```
  </Tab>
</Tabs>
...
Learn more in the [Plugin API Reference](/libraries/rempts/api/plugins).
...
See the [API Reference](/libraries/rempts/api/create-cli) for detailed documentation of all exports.