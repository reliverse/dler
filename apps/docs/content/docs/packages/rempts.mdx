...
- Learn about [Commands](/libraries/rempts/core-concepts/commands) to build your CLI
- Explore [Testing](/libraries/rempts/packages/test) to ensure reliability
- Read about [Distribution](/libraries/rempts/guides/distribution) to share your CLI