...
1. **[Hello World](/libraries/rempts/examples/hello-world)** - Absolute basics (5 min)
2. **[Task Runner](/libraries/rempts/examples/task-runner)** - Validation and interactivity (15 min)
3. **[Git Tool](/libraries/rempts/examples/git-tool)** - Command structure and organization (15 min)
4. **[Dev Server](/libraries/rempts/examples/dev-server)** - Plugins and advanced patterns (20 min)

## Example Projects

Check out these complete example projects in the [Rempts repository](https://github.com/reliverse/rempts/tree/main/examples):
