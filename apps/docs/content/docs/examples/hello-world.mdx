...
// cli.ts
#!/usr/bin/env bun
import { createCLI, defineCommand, option } from '@rempts/core'
import { z } from 'zod'
...
- **[Getting Started Guide](/libraries/rempts/getting-started)** - Step-by-step tutorial
