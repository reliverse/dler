...
- Learn about [Type Inference](/libraries/rempts/core-concepts/type-inference) for better autocomplete
- Add [Validation](/libraries/rempts/core-concepts/validation) to ensure correct input
- Explore [Configuration](/libraries/rempts/core-concepts/configuration) options
