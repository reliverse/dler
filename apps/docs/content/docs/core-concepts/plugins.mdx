...
```typescript
declare module '@rempts/core/plugin' {
...
- Explore the [Plugin API Reference](/libraries/rempts/api/plugins) for detailed API documentation
- Check out [Built-in Plugins](/libraries/rempts/packages/plugins) for ready-to-use plugins
- Learn about [Testing Plugins](/libraries/rempts/guides/testing#testing-plugins) in your CLI