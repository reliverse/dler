...
```typescript
import { loadConfig } from '@rempts/core'
...
- [Configuration](/libraries/rempts/core-concepts/configuration) - Configuration concepts
- [Build & Distribution](/libraries/rempts/guides/build-and-distribution) - Building for production