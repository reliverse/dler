...
- [Plugins](/libraries/rempts/core-concepts/plugins) - Learn about the plugin system
- [Plugin API](/docs/api/plugins) - Plugin API reference
- [Command Manifests](/libraries/rempts/core-concepts/commands#command-manifests) - Learn about lazy loading
