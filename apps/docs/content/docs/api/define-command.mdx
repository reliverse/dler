...
interface HandlerArgs<TFlags> {
  ...
  // Interactive prompts (from @rempts/utils)
  prompt: {
  ...
  // Progress spinner (from @rempts/utils)
  spinner: (text?: string) => Spinner
  
  // Terminal colors (from @rempts/utils)
  colors: Colors
...
- [option](/libraries/rempts/api/option) - Create command options
- [Commands](/libraries/rempts/core-concepts/commands) - Command concepts
- [Type Inference](/libraries/rempts/core-concepts/type-inference) - How type inference works
- [Plugins](/libraries/rempts/core-concepts/plugins) - Learn about plugins and context
- [Plugin API](/libraries/rempts/api/plugins) - Plugin API reference