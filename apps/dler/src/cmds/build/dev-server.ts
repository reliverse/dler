// apps/dler/src/cmds/build/dev-server.ts
...
export class DevServer {
  ...
  constructor(
    ...
    this.config = {
      ...
      open: devServerOptions?.open ?? false,
  ...
  async start(): Promise<void> {
    ...
    try {
      ...
      logger.success(
        `🚀 Dev server running at http://${this.config.host}:${this.config.port}`,
      );
...
<body>
  ...
  private async openBrowser(): Promise<void> {
    try {
      ...
      // Use execa for better cross-platform support
