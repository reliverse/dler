// apps/dler/src/cmds/build/validation.ts
...
export function validateBuildOptions(options: BuildOptions): ValidationError[] {
  ...
  if (options.throw === false) {
    errors.push({
      field: 'throw',
      message: 'throw: false will be deprecated in Bun 1.2 (will default to true)',
      suggestion: 'Consider removing --throw false or explicitly set --throw true'
    });
  }
