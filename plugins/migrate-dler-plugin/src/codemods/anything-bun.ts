...
const generateBunConfig = (analysis: ProjectAnalysis): string => `# Bun configuration file
[install]
cache = true
auto = "bun"
production = false
...
const generateDockerfile = (analysis: ProjectAnalysis): string => `# Use Bun's official image
