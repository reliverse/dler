...
import { generateAuthConfig } from "~/impl/better/auth/(generators)/auth-config";
import { checkPackageManagers } from "~/impl/better/auth/(utils)/check-package-managers";
import { formatMilliseconds } from "~/impl/better/auth/(utils)/format-ms";
import { generateSecretHash } from "~/impl/better/auth/(utils)/generate-secret";
import { getPackageInfo } from "~/impl/better/auth/(utils)/get-package-info";
import { getTsconfigInfo } from "~/impl/better/auth/(utils)/get-tsconfig-info";
import { installDependencies } from "~/impl/better/auth/(utils)/install-dependencies";
...
async function formatWithBiome(code: string, _filepath: string): Promise<string> {
...
type SupportedFrameworks = "vanilla" | "react" | "vue" | "svelte" | "solid" | "nextjs";
