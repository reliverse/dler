...
6. `dler publish` publishes all packages to npm and jsr (soon). Handles version bumping, and different validations. Automatically loads .env files for authentication. Supports dler.ts configuration for per-package settings.
